...
const playedElement = document.querySelector('[data-played]');
const currentStreakElement = document.querySelector('[data-current-streak]');
const maxStreakElement = document.querySelector('[data-max-streak]');
...
function resetKeyboard() {
  const usedKeys = keyboard.querySelectorAll('[data-state]');
...
function submitGuess() {
  ...
  // if word is enough but not present
...
function populateStat() {
  playedElement.textContent = played;
  currentStreakElement.textContent = currentStreak;
  maxStreakElement.textContent = longestStreak;
}
